...
public class Update_Employee extends JFrame implements ActionListener
{
  ...
  JTextField name_text,address_text,mob_no_text,password_text,email_id_text,position_text,team_text;
  JButton enter,back;
  String emp_back;
  Update_Employee(String empid,String empback)
  {
      emp_back = empback;
      setTitle("Update Employee Data");
      getContentPane().setBackground(Color.WHITE);
      title = new JLabel("UPDATE EMPLOYEE DATA");
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      if(e.getSource() == enter)
      {
         ...
         {
             Connections c = new Connections();
             String query = "update employee set name = '"+name+"', address = '"+address+"', mob_no = '"+mob_no+"', pass_word = '"+password+"', email_id = '"+email_id+"', position = '"+position+"', team = '"+team+"' where emp_id = '"+emp_id+"'";
